#!/usr/bin/env python3
"""One-shot eval for sasrec_shuffle_only — simple protocol matching eval_by_seqlen.py."""
...
CK_PATH  = Path("runs/sasrec_shuffle_only/best.pt")
DATA_PKL = Path("data/processed.pkl")
OUT_CSV  = Path("profiles/predictions_shuffle_only.csv")
NEG_INF  = -1e9
